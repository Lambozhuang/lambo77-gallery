      ...
      <div class="page">
        <div class="row mt-5 gy-2">
          <div class="col-xs-12 col-md-9">
            <router-link to="/">
              <h1 class="site-name d-inline-block">Gallery in Lambo77's World</h1>
            </router-link>
          </div>
          <div class="col-xs-12 col-md-3 d-flex flex-row-reverse align-items-center">
            <a class="nav-item" href="https://lambo77.world" title="Home" target="_blank">Home</a>
            <a
              class="nav-item"
        ...
        <div v-for="(section, index) in this.sections" :key="index">
          <div class="row">
